...
<html lang="en"  data-theme="dark">
  ...
  <?php
  $countries = ["Sverige","Finland", "Kanada"];
  ?>
  ...
  <body>
    ...
    <header class="container">
      <hgroup>
        <h1>Stefan Super PHP Demo</h1>
        <h2>Kolla vad najsigt det är med PHP</h2>
      </hgroup>
    </header>
    <!-- ./ Header -->
...
<?php
      ...
      <section id="test">
        ...
        <form>
                    ...
                    <input type="search" id="searchPlayer" name="search" placeholder="Search" />
          
        </form>

        <table role="grid" id="allPlayers">
          <thead>
            <tr>
